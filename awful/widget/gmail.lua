...
function M.new(args)
    ...
    gmail.image = {
        ["disabled"] = awful.util.getdir("config") .. "/awful/widget/gmail-icons/mail-disabled.png",
        ["active"] = awful.util.getdir("config") .. "/awful/widget/gmail-icons/mail.png",
        ["new"] = awful.util.getdir("config") .. "/awful/widget/gmail-icons/mail-new.png",
    }
